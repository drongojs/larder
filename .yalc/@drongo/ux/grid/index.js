...
import { useBreakpoints } from '@drongo/ux/breakpoints';
import { perc } from '@drongo/ux/theme';
...
var useFlex = (function (_props) {
  var props = reactive(_objectSpread2({}, defaultProps, {}, toRefs(_props)));
  return computed(function () {
    return getStyles(stylesheet, props).root;
  });
});
...
var script = defineComponent({
  ...
  setup: function setup(props) {
    ...
    var breakpoint = computed(function () {
      if (breakpoints.isMinXl && props.xl) {
        return props.xl;
      }

      if (breakpoints.isMinLg && props.lg) {
        return props.lg;
      }

      if (breakpoints.isMinMd && props.md) {
        return props.md;
      }

      if (breakpoints.isMinSm && props.sm) {
        return props.sm;
      }
    ...
    var grow = computed(function () {
      return breakpoint.value === 'fill';
    });
    var basis = computed(function () {
      ...
      return perc(Number(v) * 100 / 12);
    });
    var flexStyles = useFlex(reactive({
      grow: grow,
      basis: basis,
      direction: 'column'
    }));
...
var script$1 = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var flexProps = reactive(_objectSpread2({
      direction: 'column'
    }, toRefs(props), {}, toRefs(attrs)));
...
var script$2 = defineComponent({
  ...
  setup: function setup(props, _ref) {
    var attrs = _ref.attrs;
    var flexStyles = useFlex(reactive(_objectSpread2({
      direction: 'row',
      block: true
    }, toRefs(props), {}, toRefs(attrs))));
    return {
...
export { __vue_component__ as Column, __vue_component__$1 as Container, Grid, __vue_component__$2 as Row, useFlex };
