...
var stylesheet = function stylesheet(props) {
  ...
  var _theme$font = theme$1.font,
      ...
      grey = theme$1.palette.grey.color,
  ...
  return {
    default: {
      root: {
        ...
        paddingTop: theme.gu2px(0.5, theme$1),
        paddingRight: theme.gu2px(1, theme$1),
        paddingBottom: theme.gu2px(0.5, theme$1),
        paddingLeft: theme.gu2px(1, theme$1),
    ...
    enabled: {
      root: {
        ':hover': {
          backgroundColor: theme.getHighlightColor(background).string(),
          color: theme.getHighlightColor(foreground).string()
        },
        ':active': {
          borderStyle: 'inset',
          backgroundColor: theme.getFocusColor(background).string(),
          color: theme.getFocusColor(foreground).string()
        }
      }
    },
    block: {
...
var script = compositionApi.defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var enabled = compositionApi.computed(function () {
