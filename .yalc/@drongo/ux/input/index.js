...
import { useTheme, useKind, perc, gu2px, Kind } from '@drongo/ux/theme';
  ...
  return {
    default: {
      ...
      input: {
        ...
        paddingTop: gu2px(0.25, theme),
        paddingRight: gu2px(0.5, theme),
        paddingBottom: gu2px(0.25, theme),
        paddingLeft: gu2px(0.5, theme),
      ...
      icon: {
        position: 'absolute',
        right: gu2px(0.25, theme),
        top: gu2px(0.25, theme)
      }
    },
    disabled: {
      input: {
...
export { __vue_component__ as Input };
