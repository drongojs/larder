...
import { useTheme } from '@drongo/ux/theme';
...
var Accordion = defineComponent({
  ...
  setup: function setup(props, _ref) {
    var emit = _ref.emit;
    var theme = useTheme();
    var styles = getStyles(stylesheet$2);
...
export { __vue_component__$2 as Accordion };
