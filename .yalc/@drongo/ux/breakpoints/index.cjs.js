...
var useWindowWidth = function useWindowWidth() {
  var width = compositionApi.ref(window.innerWidth);
...
var getBreakpoints = function getBreakpoints(width) {
  var bp = compositionApi.reactive({
    isMinXs: false,
    isMinSm: false,
    isMinMd: false,
    isMinLg: false,
...
var script = compositionApi.defineComponent({
  setup: function setup() {
    ...
    compositionApi.provide(BreakpointsKey, breakpoints);
  }
});
...
var script$1 = compositionApi.defineComponent({
  ...
  setup: function setup(props) {
    var width = compositionApi.computed(function () {
      switch (props.size) {
        case 'xl':
...
var useBreakpoints = function useBreakpoints() {
  var bp = compositionApi.inject(BreakpointsKey, null);
...
exports.BreakpointsKey = BreakpointsKey;
exports.Provider = __vue_component__;
exports.StubProvider = __vue_component__$1;
