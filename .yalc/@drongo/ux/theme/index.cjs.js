...
var useStyles = _interopDefault(require('@drongo/styles'));
var hooks = require('@drongo/ux/hooks');
...
var provideTheme = (function () {
  ...
  compositionApi.provide(ThemeProvideKey, compositionApi.isRef(theme) ? theme : compositionApi.ref(theme));
});
...
var useTheme = (function () {
  var theme = compositionApi.inject(ThemeProvideKey, null);
...
var useKind = (function (theme, _kind, _invert) {
  var inheritedKind = compositionApi.inject(KindKey, null);
  var inheritedInvert = compositionApi.inject(InvertKey, null);
  var kind = compositionApi.computed(function () {
    var kind = hooks.unwrap(_kind);
  ...
  var invert = compositionApi.computed(function () {
    var invert = hooks.unwrap(_invert);
  ...
  compositionApi.provide(KindKey, kind);
  compositionApi.provide(InvertKey, invert);
  var background = compositionApi.computed(function () {
    var kindKey = getKindKey(kind.value);
    var t = compositionApi.isRef(theme) ? theme.value : theme;
    var palette = t.palette[kindKey];
    return invert.value ? palette.color : palette.contrast;
  });
  var foreground = compositionApi.computed(function () {
    var kindKey = getKindKey(kind.value);
    var t = compositionApi.isRef(theme) ? theme.value : theme;
    var palette = t.palette[kindKey];
    return invert.value ? palette.contrast : palette.color;
  });
  var border = compositionApi.computed(function () {
...
exports.Kind = Kind;
exports.Provider = __vue_component__;
exports.StyleRoot = __vue_component__$1;
exports.getBorderColor = getBorderColor;
exports.getFocusColor = getFocusColor;
exports.getHighlightColor = getHighlightColor;
exports.getKindByKey = getKindByKey;
exports.getKindKey = getKindKey;
exports.getKindKeys = getKindKeys;
exports.gu2px = gu2px;
exports.perc = perc;
exports.provideTheme = provideTheme;
exports.useKind = useKind;
