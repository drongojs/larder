import { createComponent, inject, computed, provide, onCreated, defineComponent } from '@vue/composition-api';
import { componentFromSlot } from 'vue-compose';
import __vue_normalize__ from 'vue-runtime-helpers/dist/normalize-component.js';
import { Icon } from '@drongo/ux/icon';
import { Kind } from '@drongo/ux/theme';
import { Button } from '@drongo/ux/button';
...
var getForm = function getForm() {
  var state = inject(FormProvideKey, null);
...
var InnerField = componentFromSlot();
...
var script$1 = defineComponent({
  ...
  setup: function setup(props) {
    ...
    var iconProps = computed(function () {
      if (form.submitting) {
        return {
          icon: 'spinner',
          pulse: true
...
export { __vue_component__ as Submit };
